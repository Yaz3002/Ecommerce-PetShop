  ...
  return (
    <section className="relative h-[400px] md:h-[500px] overflow-hidden -mx-6 sm:-mx-8">
      <div className="absolute inset-0">
        <img
          src="https://images.unsplash.com/photo-1514888286974-6c03e2ca1dba?q=80&w=1600"
          alt="Gatos elegantes"
      ...
      <div className="relative h-full container mx-auto px-4 flex flex-col justify-center items-center text-center">
        ...
        >
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4 font-heading">
            Elegancia para tu <span className="text-primary">felino</span>
          </h1>
          <p className="text-lg md:text-xl opacity-95 mb-6 max-w-lg mx-auto">
            Descubre nuestra colección exclusiva de ropa y accesorios para que tu gato luzca con estilo y comodidad.
          </p>
