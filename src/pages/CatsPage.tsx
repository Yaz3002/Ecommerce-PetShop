...
// Import components
import CatHero from "@/components/cats/CatHero";
import ProductsSection from "@/components/cats/ProductsSection";
import SizingGuide from "@/components/cats/SizingGuide";
...
const CatsPage = () => {
  // Use explicit 'cat' literal type instead of string
  const animalType: 'cat' = 'cat'; 
